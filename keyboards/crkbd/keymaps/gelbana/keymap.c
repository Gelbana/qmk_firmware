...
[0] = LAYOUT_split_3x6_3(
     ...
     KC_LSPO,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_K,    KC_H,  KC_COMM,  KC_DOT, KC_SLSH, KC_RSPC,
                                  KC_LGUI,   LT(1, KC_ESC),  KC_SPC,  LT(2, KC_ENT),   LT(3, KC_TAB),  LT(4, KC_RALT)
  ),

[1] =  LAYOUT_split_3x6_3(
     QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_CAPS, KC_BSPC,
     _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, CW_TOGG,  KC_DEL,
     _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_HOME, KC_PGDN, KC_PGUP,  KC_END,  KC_INS, KC_CAPS,
                                 _______,   MO(1), _______, _______,   MO(3), _______
  ),
...
[2] = LAYOUT_split_3x6_3(
     ...
     _______, KC_GRAVE,  KC_1,      KC_2,    KC_3, KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, KC_DOT, XXXXXXX, XXXXXXX,
                                   KC_DOT,  KC_0, KC_MINUS, _______,   MO(2), _______
  ),
...
[3] = LAYOUT_split_3x6_3(
     ...
     _______, KC_TILD, KC_EXLM,   KC_AT, KC_HASH,KC_PIPE, KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD,
                               _______,   MO(3), KC_UNDS, _______,   MO(3), _______
  ),
...
[4] = LAYOUT_split_3x6_3(
     ...
     _______,  KC_F10,  KC_F1,   KC_F2,   KC_F3, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                             _______,   MO(3), _______, _______,   MO(3), _______
  ),
};
